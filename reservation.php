  ...
  <div class="container my-5 px-5">
        ...
        <h3 class="col-lg-12 mb-4"> 1. Select Date & Time</h3>
            <div class="col-auto mb-4">
              <label for="staticEmail2">Data</label>
              <input class="form-control" type="text" placeholder="Default input" aria-label="default input example" required autocomplete="off" id="userdate">
            </div>
            <div class="col-auto mb-4">
            ...
            <button type="button" class="btn btn-success px-4 py-2" id="reserve" class="next">Next</button>
            </div>
          </form>
  </div>
...
<?php
   ...
   include_once("reserve_footer.php");
